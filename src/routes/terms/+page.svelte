...
<div class="body">
    ...
    <Heading tag="h4" class="mb-4">Terms and Conditions</Heading>
    ...
    <Heading tag="h4" class="mb-4">Modifications of Terms and Conditions</Heading>
    ...
    <Heading tag="h4" class="mb-4">Use of the site</Heading>
    ...
    <Heading tag="h4" class="mb-4">Registration Information</Heading>
